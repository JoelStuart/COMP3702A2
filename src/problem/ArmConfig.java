...
public class ArmConfig {
	...
	public boolean equals(Object o){
		ArmConfig comp = (ArmConfig) o;
		//return comp.toString().equals(o.toString());
		if (comp.base.equals(this.base)){
			if (this.links != null){
				if (comp.toString().equals(this.toString())){
					if (this.hasGripper()){
						if(comp.gripperLengths.equals(this.gripperLengths)){
							return true;
						} else {
							return false;
						}
